...
2. DESIGN  →  open Pencil, design screens with full context  ← NEW
3. BUILD   →  hand the doc + designs to agents
4. REVIEW  →  Claude reviews code inline during self-analysis
5. SHIP    →  fix findings, deploy
```
